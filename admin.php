...
<div class="bd">
    ...
    <div class="menu"><div style="margin-top:5px;">
    	<a class="link_btn" href="index.php">Home</a><!--<a class="link_btn" href="about.php">About Us</a><a class="link_btn" href="product.php">Show Products</a><a class="link_btn" href="contact.php">Contact Us</a><a class="link_btn" style="float:right; margin-right:8px; margin-top:-7px; width:80px;" href="login.php">Login</a>-->
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT * FROM admin WHERE admin_id = '$myusername' and password = '$mypassword'";
...
<form action="#" method="post" onSubmit="return validate()" name="form1">
    <img class="image" src="admin.png"><div class="heading"><h2 align="center">Admin Login</h2><hr></div><br>
    <table align="center"><tr><td><p>Admin ID</p></td><td><input class="input_box" placeholder="Your User Name" type="text" name="user_id" value=""></td></tr>
