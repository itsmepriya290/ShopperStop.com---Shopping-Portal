<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
	  ...
	  // username and password sent from form previous page
...
<p align="center"><a href="register.html"><input class="lgn_rgstr" type="submit" name="register" value="REGISTER"></a></p>
</div>
</div>
</body>
</html>
